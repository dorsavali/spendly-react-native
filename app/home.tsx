...
const Home = () => {
  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView className="flex-1  bg-background p-6 w-full gap-10">
        ...
        <View className="w-full  flex gap-3">
          <View className="bg-white h-52 rounded-2xl  flex justify-center items-center gap-6">
            <Text className="font-poppins-semibold text-xl text-text-secondary">Total Balance</Text>
          ...
          <View className="flex-row justify-between gap-2">
            <View className="bg-white w-1/2 flex rounded-2xl h-32 flex justify-center items-center gap-6">
              <Text className="font-poppins-semibold text-lg text-success">Income</Text>
              <Text className="font-poppins-bold text-xl">€19,200</Text>
            </View>
            <View className="bg-white w-1/2 flex rounded-2xl h-32 flex justify-center items-center gap-6">
              <Text className="font-poppins-semibold text-lg text-danger">Expense</Text>
